...
You produce a complete adapted Chinese article with its English mirror and its rationale. Not a translation. Not a summary.

## Core Principle

**A weak translation carries the words across. A cultural adaptation carries the effect across.**
...
- Growing a Chinese X account from scratch (niche, algorithm, pull-what-works) → `max-x`, then adapt the winners with this
...
- **Cultural adaptation** (advertising-localization industry; TransPerfect / Lionbridge) — adapt content for emotional and cultural *impact*, not literal words; preserve intent, tone, and effect even when that means rewriting wholesale. The named discipline this whole skill sits inside.
...
1. **Chinese readers save; English readers react.** The whole cultural adaptation bends toward *being saved*: depth, reference value, a title that promises a keepable thing. (#1, #2)
...
A cultural adaptation that keeps the English answer-first order will read to a Chinese reader as blunt and thin. Re-order it.
...
> **Cultural adaptation (what to ship):**
...
3. **The adapted article** — block by block, each block as a pair:
   - 中文 (the Chinese text)
...
- Adapt, do not translate. If the output reads like a faithful translation, you skipped Part III.
...
**The canon (Part I):** Cultural adaptation (industry) · Skopos — Vermeer & Reiss 1978 · Dynamic equivalence — Nida 1964 · Domestication/Foreignization — Venuti 1995 · High/low-context — Hall 1976 · 起承转合 + contrastive rhetoric — Fan Heng 1330 / Kaplan 1966 · Hofstede dimensions · 研报/KOL trust economy — PANews, ChainCatcher.
